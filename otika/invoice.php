          ...
          <div class="section-body">
            <div class="invoice">
              <div class="invoice-print">
                ...
                $sql = "SELECT * FROM `user` WHERE `uorder`='$uinvoice'";
                ...
                ?>
                  <div class="col-lg-12">
                    <div class="invoice-title">
                      <h2>Invoice</h2>
                      <div class="invoice-number"><?php echo $row['uorder'] ?></div>
                    </div>
                    <hr>
                    <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <address>
                          ...
                          <?php echo $row['op_method'] ?><br>
                        </address>
                      </div>
                      <div class="col-md-6 text-md-right">
                        <address>
                          <strong>Order Date:</strong><br>
                          <?php echo $row['odate'] ?><br><br>
                        </address>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped table-hover table-md">
                        ...
                        <?php
                        $uinvoice=$_GET['uinvoice'];
                $sql = "SELECT * FROM `myorder` WHERE `uorder`='$uinvoice'";
                $exe=mysqli_query($conn,$sql);
                $gt=0;
                while($row=mysqli_fetch_array($exe)){
			          ?>
                        <tr>
                          ...
                          <td class="text-center"><?php echo $row['mqty'] ?></td>
              ...
              <div class="text-md-right">
                <div class="float-lg-left mb-lg-0 mb-3">
                  <a href="vieworder.php" type="button" class="btn btn-primary btn-icon icon-left"><i data-feather="briefcase"></i><strong> Back to Orders</a>
                </div>
