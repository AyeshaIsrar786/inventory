                        ...
                        <div class="shop__sidebar__accordion">
                            <div class="accordion" id="accordionExample">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" data-parent="#accordionExample">
                                        <div class="card-body">
					                        ...
					                        ?>
                                            <li>
                                            <a href="./viewcat.php?catid=<?php echo $crow['cid'];?>"><?php echo $crow['cname'] ?>(20)</a>
                                            </li>
                                            <?php } ?>
                                                </ul>
                                            </div>
                                ...
                                <div class="card">
                                    ...
                                    ?>
                                    <li><a href="#"><?php echo $scrow['scname'] ?><a></li>
                                    <?php } ?>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                ...
                                <div class="product__item__text">
                                    ...
                                    <input type="hidden" id="ppic" name="ppic" value="<?php echo $row['ppic'] ?>">  
                                    <a href="#" id="addcart" >+ Add To Cart</a>
                                    </form>
                                    <h5>RS.<?php echo $row['srp'] ?></h5>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
...
<script>
        ...
        var myform=$(this).closest(".formsubmit");
        var pid= myform.find("#pid").val();
        var pname= myform.find("#pname").val();
        var pcode = myform.find("#pcode").val();
        var srp = myform.find("#srp").val();
        var ppic = myform.find("#ppic").val();
